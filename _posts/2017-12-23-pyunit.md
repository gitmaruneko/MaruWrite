...
<figure class="foto-legenda">
	<img src="{{ "/assets/img/maruIMG/20171223/01.jpg"}}" width="700" height="598" alt="" >
</figure>
...
<figure class="foto-legenda">
	<img src="{{ "/assets/img/maruIMG/20171223/06.jpg"}}" width="700" height="500" alt="" >
</figure>
...
<figure class="foto-legenda">
	<img src="{{ "/assets/img/maruIMG/20171223/07.jpg"}}" width="200" height="143" alt="" >
</figure>
...
> 輸入package name
<figure class="foto-legenda">
	<img src="{{ "/assets/img/maruIMG/20171223/08.png"}}" width="800" height="650" alt="" >
</figure>

依據以下結構個別於src及test 資料夾內建立好 **a00** package

<figure class="foto-legenda">
	<img src="{{ "/assets/img/maruIMG/20171223/09.png"}}" width="338" height="257" alt="" >
</figure>
